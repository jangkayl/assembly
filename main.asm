...
;--- data for payment
	payment		DB " ._________________________________________________________________.", 0dH, 0aH
			...
			DB " |-----------------ITEMS-----------------|---Qty---|-Subtotal (PHP)-|", 0dH, 0aH, "$"
	space1		DB "   |    $"
	subTf		DW 3 DUP (0)
	subTDf		Dw 3 DUP (0)
	subTb		DW 4 DUP (0)
	...
	space2		DB "     |$"
	paymentL	DB " '-----------------------------------------------------------------'", 0dH, 0aH, "$"
	delistate	DB "                                     Delivery Fee : PHP   $"
	deliFee		DB 5
	packageTax	DB "                                    Packaging Tax : PHP   $"
	packageFee	DB 5; 5%
	pack		DB 0
	packD		DB 0
	SSTstate	DB "                                          SST(5%) : PHP   $"
	SSTTax		DB 5; 5%
	SST		DB 0
	SSTD		DB 0
	ifMem		DB 0	; get member 
	dctstate	DB "                                         Discount : PHP   $"
	discount	DB 10; 10%
	disc		DB 0
	discD		DB 0
	roundstate	DB "                                     Rounding Adj : PHP   $"
...
;--- data for reporting
	...
	expL		DB "     '-------------------------------------------------'", 13, 10, "$"
	Rmsg1		DB 13, 10, "                                 Total SST Collection :   PHP $"
	Rmsg2		DB 13, 10, "                                       Total Discount : - PHP $"
	Rmsg3		DB 13, 10, "                                        Total Earning :   PHP $"
	Rmsg6		DB 13, 10, "                                        Extra Charges :   PHP $"
	Rmsg7		DB 13, 10, "                         Cash Out Amount :   PHP $"
...
;--- data for membership
	...
	memRenew	DB	" |-----------------------OPTION----------------------|", 0dH, 0aH
			DB	" |        1. 3 Months                PHP 20.00        |", 0dH, 0aH
			DB      " |        2. 6 Months                PHP 35.00        |", 0dH, 0aH
			DB	" |        3. 1 Year                  PHP 45.00        |", 0dH, 0aH
			DB	" |        4. Return                                  |", 0dH, 0aH, "$"
	...
	memPay		DB	"Enter amount for payment  PHP(Min. 20|Max. 99) :",0dH, 0aH, "$"
	errorMemPayMsg	DB	"Invalid amount. Please try again.",0dH, 0aH, "$"
	memPayBalance	DB	"Balance : PHP ", "$"
	...
	pack1mem	DB	"Package Price : PHP 20", 0dh, 0ah, "$"
	pack2mem	DB	"Package Price : PHP 35", 0dh, 0ah, "$"
	pack3mem	DB	"Package Price : PHP 45", 0dh, 0ah, "$"
	inputDate	DB	11	DUP	("$")
